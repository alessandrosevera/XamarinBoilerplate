...
{
    public partial class UnknownCustomerCredentialsOverlayPresenter : AbsoluteLayout, OverlayPresenter, LocalizableElement
    {
        ...
        public UnknownCustomerCredentialsOverlayPresenter()
        {
            InitializeComponent();
        }
        ...
        {
            PopupTitle.Text = catalog.GetString("Accesso non riuscito");
            PopupText.HtmlText = catalog.GetString("Non è stato possibile recuperare i dati di accesso dell'utente, per favore <b>ripeti la login</b> o <b>torna alla home</b>.");
